...
class FindSimilarPanel(base.MyPanel):
    ...
    def __init__(self, parent):
        ...
        label = (
			'Find faces that are similar to a given face (the query face).\n'
			'Click "Load Candidate Faces" to select a folder containing images '
			'of the faces you want to compare to the query face.\n'
