...
class IdentificationPanel(base.MyPanel):
    ...
    def __init__(self, parent):
        ...
        label = (
            '1) Place face images of one person in a folder and give the folder the same name as that person.\n'
            ...
            '5) Click "Choose Image" to select a different image representing one of the people for whom you created folders above. '
        )
